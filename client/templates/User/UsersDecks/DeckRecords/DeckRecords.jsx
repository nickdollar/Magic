...
export default class DeckRecords extends React.Component {
    ...
    addDeckRecord(){
        Meteor.call("addDeckToRecordMethod", {UsersDeck_id : this.props.UsersDeck._id, deckName : this.refs["DeckName"].value}, ()=>{
                                ...
                                return  <td key={option.value}>
                                            <div className="topLevel">
                                                ...
                                                <div className="changeButtons">
                                                    <div onClick={(event)=>this.updateVictories({target : event.target, name : row.name, value : option.value, index : index, upDown : "up", winLoss: option.winLoss})} className="arrow-up"></div>
                                                    <div onClick={(event)=>this.updateVictories({target : event.target, name : row.name, value : option.value, index : index, upDown : "down", winLoss: option.winLoss})} className="arrow-down"></div>
                                                </div>
                                            </div>
                                        </td>
                            })}
                        ...
                        <tr>
                            ...
                            {losingOptions.map((option, index)=>{
                                return  <td key={option.value}><div className="topLevel">
                                            <div className="js-quantity">{row[option.value] ? row[option.value] : 0}</div>
                                            <div className="changeButtons">
                                                            <div onClick={(event)=>this.updateVictories({   target : event.target,
                                                                                                            name : row.name,
                                                                                                            value : option.value,
                                                                                                            index : index,
                                                                                                            upDown : "up",
                                                                                                            winLoss: option.winLoss
    ...
    render(){
        const options =
            {
                ...
                data : this.props.UsersDeck.decks ? this.props.UsersDeck.decks : [],
                pagination : true
            }
        ...
        return(
            <div className="DeckRecordsComponent">
                <div>
                    <input type="text" ref="DeckName"/><button className="btn" onClick={this.addDeckRecord.bind(this)}>Add a Deck</button>
                </div>
