    ...
    render(){
        return (
            <div className="AddEventToCollectionComponent">
                ...
                <button onClick={()=>this.callFunction("eventLeagueDailyMethod", {format : this.props.format, days : 5, dateType : "lastDays"})}
                        type="button" style={{backgroundColor : "#3399ff"}} className="btn btn-block">League Daily lastDays</button>
                <button onClick={()=>this.callFunction("eventLeagueDailyMethod", {format : this.props.format, days : 5, dateType : "oldDays"})}
                        type="button" style={{backgroundColor : "#3399ff"}} className="btn btn-primary btn-block">League Daily oldDays</button>
                ...
                <button onClick={()=>this.callFunction("methodGetGPPositions", {})}
                        type="button" style={{backgroundColor : "red"}} className="btn btn-block">Get Positions</button>
