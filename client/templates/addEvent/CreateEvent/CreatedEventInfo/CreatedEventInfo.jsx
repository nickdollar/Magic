...
class CreateEventInfo extends React.Component{
    ...
    render() {
        return (
            <div>
                <button onClick={this.props.resetForm}>Reset Form</button>
                <div>
                    <span className="rightTitle">LGS: </span><span className="leftInformation">{this.storeName()}</span>
                </div>
                <div>
                    <span className="rightTitle">Event Title: </span><span className="leftInformation">{this.props.eventInfo.name}</span>
                </div>
                <div>
