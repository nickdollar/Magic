...
createEventsTypes = ()=>{
    ...
    var eventsArray = [
        ...
        {
            _id : "SCGInvi",
            name : "SCG Invitational",
            states : [{name : "SCGCreated", order : 1}, {name : "decks", order : 2}],
            short : "SCG Inviational",
            size : 1,
            owner_id : 21,
            venue : "SCG",
            website : "StarCityGames.com",
        ...
        {
            _id : "SCGInviQual",
            name : "SCG Invitational Qualifier",
            states : [{name : "SCGCreated", order : 1}, {name : "decks", order : 2}],
            short : "SCG Invi Qual",
            size : 0,
            owner_id : 29,
        ...
        {
            _id : "SCGPlayersChamp",
            name : "SCG Players' Championship",
            states : [{name : "SCGCreated", order : 1}, {name : "decks", order : 2}],
            short : "SCG Players' Champ",
            size : 0,
            owner_id : 48,
            venue : "SCG",
            website : "StarCityGames.com",
        ...
        },
        {
            _id : "MTGPT",
            name : "Pro Tour",
            states : [{name : "created", order : 1}, {name : "finalStanding", order : 2}, {name : "pending", order : 4}, {name : "decks", order : 3}],
            short : "PT",
            size : 1,
            venue : "WotC",
            website : "http://magic.wizards.com",
