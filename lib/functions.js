...
getQuantity3 = function(options, sideboard, _deckID){
    options = typeOptions[options];
    var cards = _CardDatabase.find(options).map(function(p) { return p.name });
    var deck = _temp2.findOne({_id : _deckID});

    var total = 0;
    cards.forEach(function(obj1){
