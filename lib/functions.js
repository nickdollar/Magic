...
fixTimeZone = (timezoneHours, currentTimezone, finalTimezone)=>{
    var difference = 0;
    difference = Math.abs(Math.abs(currentTimezone) - Math.abs(finalTimezone));
    currentTimezone > finalTimezone ? difference *= -1 : null;
    return timezoneHours + difference;
}
