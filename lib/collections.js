...
ArchetypesShells = new Mongo.Collection("ArchetypesShells");
DecksNamesShells = new Mongo.Collection("DecksNamesShells");
...
TCGPlayerCardsPrices = new Mongo.Collection("TCGPlayerCardsPrices");
